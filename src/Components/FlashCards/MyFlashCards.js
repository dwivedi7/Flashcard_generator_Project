              ...
              <div className=" m-2 flex dark:text-blue-400 hover:scale-110 overflow-hidden justify-center pt-12 drop-shadow-md" key={elem.id} >
                ...
                <div className="bg-white border dark:bg-gray-700 px-4 w-[250px] xl:w-[300px] sm:w-[300px] lg:w-[300px] md:w-[300px] h-64  pt-11 pb-2 rounded-lg dark:border-gray-500 ">
                  ...
                  <div className="flex flex-col items-center ">
                    ...
                    <button onClick={() => navigate(`/flashcardsdetails/${elem.id}`)} className="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
                    >
                      View Cards
                    </button>
                  </div>

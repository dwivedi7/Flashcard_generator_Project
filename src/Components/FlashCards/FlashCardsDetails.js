    ...
    <>
      <div className="pt-3 dark:text-white">
        <span className='flex'>
          ...
          <BsFillArrowLeftCircleFill onClick={() => navigate(-1)} className='text-2xl m-1 cursor-pointer hover:text-red-600 ' />
        ...
        <div className="flex flex-wrap space-between">
          ...
          <div className=" w-[250px] my-3  rounded-lg h-48">
            <div onClick={() => setVisible(true)} className="bg-white dark:bg-gray-800 flex cursor-pointer mb-4 drop-shadow-md hover:scale-110 rounded-lg w-[250px] p-2 h-10"><BiShare className='text-2xl mx-5' />Share</div>
            <div className="bg-white dark:bg-gray-800 flex cursor-pointer my-4 drop-shadow-md hover:scale-110 rounded-lg w-[250px] p-2 h-10"><FiDownload className='text-2xl mx-5' />Download</div>
            <div onClick={() => { window.print() }} className="bg-white dark:bg-gray-800 flex cursor-pointer my-4 drop-shadow-md hover:scale-110 rounded-lg w-[250px] p-2 h-10"><FaPrint className='text-2xl mx-5' />Print</div>
          </div>

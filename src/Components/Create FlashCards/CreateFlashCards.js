        ...
        {({ values, handleChange, handleBlur, setFieldValue }) => (
          <Form>
              ...
              <div className="flex flex-wrap">
                  ...
                  if image is not present its shows image uploading button */}
                  {
                    values.uploadimage ? (<div className='flex '> <img className='h-16 mt-2' src={values.uploadimage} alt="" /> <TiDeleteOutline className='text-3xl text-red-600' onClick={() => setFieldValue("uploadimage", '')} /> </div>) :
                      (<label htmlFor='uploadimage'
                        className="w-48 h-[38px]  cursor-pointer px-3 mx-3 mt-8 py-1 bg-white border-gray-200 flex  items-center justify-center  rounded" >
                        <MdUploadFile
                ...
                <div className="w-full my-2 px-3">
                  ...
                  <Field
                    ...
                    name='description'
                    rows="3"
                    className="block my-2 p-2.5 w-3/4 text-sm text-gray-700  rounded  border-gray-200  focus:border-gray-500 focus:bg-white bg-white  "
                        ...
                        <div className='flex'>
                          ...
                          if image is not present its shows image uploading button */}
                          {
                            term.term_uploadimage ? ((<div className='flex  '> <img className='h-16 mt-2  max-w-[12rem]' src={term.term_uploadimage} alt="" /> <TiDeleteOutline className='text-3xl text-red-600' onClick={() => setFieldValue(`term.${index}.term_uploadimage`, '')} /> </div>)) :
                              (<label htmlFor={`term.${index}.term_uploadimage`} className="w-44 h-[38px] cursor-pointer px-3 mx-3 mt-8 py-1 bg-white border-gray-200 flex  items-center justify-center  rounded" >
            ...
            <div className="h-28 flex  items-center justify-center">
              ...
              <button type='submit'
                className="text-white bg-red-700 hover:bg-red-800  font-bold py-2 px-14 rounded focus:outline-none focus:ring-4 focus:ring-red-300 text-sm text-center mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 ">
                Create
              </button>
            </div>
          </Form>
